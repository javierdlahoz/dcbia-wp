...
<?php 
    if((wp_get_current_user()->ID != 0 && !MemberHelper::isCurrentAccountActive() 
        && wp_get_current_user()->membership_levels[0]->name != "unpaid") && wp_get_current_user()->roles[0] != "administrator" ): ?>
    <div class="container all-pad-gone">
        <div class="row">
